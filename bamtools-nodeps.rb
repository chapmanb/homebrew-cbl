...
# Standard bamtools formula but without cmake requirement which causes
# build dependency issues when trying to pull in openssl and pkg-config

class BamtoolsNodeps < Formula
